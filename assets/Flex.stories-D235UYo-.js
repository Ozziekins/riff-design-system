import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{n as y}from"./emotion-styled.browser.esm-C72mIjNC.js";import{s as r}from"./spacing-CXxPM5Gd.js";import{a as $,B as s}from"./Box-Co1u9hro.js";import{c as n}from"./colors-CjWye8Go.js";import"./iframe-B9pREkj5.js";import"./radii-D7JxPC8t.js";const v=y("div")`
  display: flex;
...
`,t=({justify:o="flex-start",align:c="stretch",direction:x="row",gap:p=4,children:m,role:u,"aria-label":g,"aria-describedby":b,...f})=>e.jsx(v,{justify:o,align:c,direction:x,gap:p,role:u,"aria-label":g,"aria-describedby":b,...f,children:m}),R={title:"Layout/Flex",component:t,tags:["autodocs"],args:{justify:"flex-start",align:"stretch",direction:"row",gap:4},parameters:{docs:{description:{component:"The `Flex` component arranges elements using CSS Flexbox. Use it for layout primitives with full control of direction, alignment, spacing, and flow. ✨"}}}},a={args:{},render:o=>e.jsxs(t,{...o,role:"group","aria-label":"Example flex group",children:[e.jsx(s,{backgroundColor:"color-primary-crimson-red",padding:4,borderRadius:"md",children:e.jsx("span",{style:{color:n.primaryText},children:"Box 1"})}),e.jsx(s,{backgroundColor:"black",padding:4,borderRadius:"md",children:e.jsx("span",{style:{color:n.secondaryText},children:"Box 2"})}),e.jsx(s,{backgroundColor:"color-neutral-1",padding:4,borderRadius:"md",children:e.jsx("span",{style:{color:n.text},children:"Box 3"})})]})};var l,d,i;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {},
