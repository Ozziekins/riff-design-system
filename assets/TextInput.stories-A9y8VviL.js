import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{n as b}from"./emotion-styled.browser.esm-C72mIjNC.js";import{c as e}from"./colors-CjWye8Go.js";import{t as s}from"./typography-CGyrGtcf.js";import{s as u}from"./spacing-CXxPM5Gd.js";import{H as L}from"./HelpText-CTjb4qov.js";import{r as A}from"./iframe-B9pREkj5.js";import"./Text-DvxuGwJ_.js";const P=b("div")`
  display: flex;
...
`,E=({label:r,helperText:o,tone:t="default",id:p,role:k,"aria-label":w,"aria-describedby":z,"aria-hidden":F,...H})=>{const m=p??`textinput-${Math.random().toString(36).substr(2,9)}`,h=o?`${m}-helper`:void 0;return a.jsxs(P,{children:[r&&a.jsx(R,{htmlFor:m,children:r}),a.jsx(_,{id:m,tone:t,role:k,"aria-label":w,"aria-describedby":h??z,"aria-hidden":F,"aria-invalid":t==="error",...H}),o&&a.jsx(L,{id:h,tone:t,children:o})]})},J={title:"Form/TextInput",component:E,tags:["autodocs"],args:{label:"First Name",placeholder:"Enter your first name",helperText:"",tone:"default",disabled:!1},argTypes:{tone:{control:{type:"select"},options:["default","error","success"]},label:{control:"text"},placeholder:{control:"text"},helperText:{control:"text"},disabled:{control:"boolean"}},parameters:{docs:{description:{component:"The `TextInput` component displays a single-line text field with an optional label and helper text. It supports tone (`default`, `error`, `success`), disabled state, full ARIA accessibility — perfect for modern forms! 🎸✨"}}}},i=r=>{const[o,t]=A.useState("");return a.jsx(E,{...r,value:o,onChange:p=>t(p.target.value)})},n={render:i},l={args:{tone:"error",helperText:"Please enter a valid name."},render:i},c={args:{tone:"success",helperText:"Looks good! 🎸"},render:i},d={args:{disabled:!0,placeholder:"Disabled input"},render:i};var f,x,g;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...
  render: Template
}`,...(D=(W=d.parameters)==null?void 0:W.docs)==null?void 0:D.source}}};const K=["Default","WithError","WithSuccess","WithDisabled"];export{n as Default,d as WithDisabled,l as WithError,c as WithSuccess,K as __namedExportsOrder,J as default};
