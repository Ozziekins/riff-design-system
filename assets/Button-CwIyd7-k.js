import{j as k}from"./jsx-runtime-D_zvdyIk.js";import{n as $}from"./emotion-styled.browser.esm-C72mIjNC.js";import{c as o}from"./colors-CjWye8Go.js";import{t as d}from"./typography-CGyrGtcf.js";import{s as l}from"./spacing-CXxPM5Gd.js";import{r as y}from"./radii-D7JxPC8t.js";const i={small:{padding:`${l[3]} ${l[3]}`,fontSize:d.sizes.caption},large:{padding:`${l[3]} ${l[4]}`,fontSize:d.sizes.body}},g=$("button")`
  display: inline-flex;
  align-items: center;
...
`,f=({variant:r="primary",size:t="small",role:e,"aria-label":a,"aria-describedby":n,"aria-hidden":b,disabled:c,children:s,...u})=>k.jsx(g,{variant:r,size:t,role:e,"aria-label":a,"aria-describedby":n,"aria-hidden":b,"aria-disabled":c,disabled:c,...u,children:s});export{f as B};
